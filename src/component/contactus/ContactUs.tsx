const ContactUs = () => {
 return (
  ...
  <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-md h-screen">
      ...
      <p className="mb-8 lg:mb-16 font-light text-center text-gray-500 dark:text-gray-400 sm:text-xl">Got a technical issue? Want to send feedback about CryptonaryBit? or Need details about our plans? Let us know.</p>
      <form action="#" className="space-y-8">
          ...
          <button type="submit" className="py-3 px-5 text-sm font-medium text-center text-black rounded-lg bg-primary sm:w-fit hover:bg-white  focus:ring-4 focus:outline-none focus:ring-primary-300 dark:focus:ring-primary-800">Send message</button>
      </form>
  </div>
</section>
    </>
